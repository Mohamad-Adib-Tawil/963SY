...
class AppLocalizationsAr extends AppLocalizations {
  ...
  String get whoWeAreContent =>
      'مؤسسة آرت فلاي رائدة في الابتكار والتوثيق، متخصصة في التصوير الجوي باستخدام تقنية الطائرات بدون طيار.';

  @override
  String get whatIs963SYContent =>
      '963SY هو منصة شاملة للهواتف المحمولة تجعل السياحة في متناول الجميع، بغض النظر عن الحواجز الجسدية أو اللغوية.';

  @override
  String get ourMissionContent =>
      'نهدف إلى تعزيز التاريخ الغني لسوريا وتراثها ومعالمها السياحية من خلال محتوى وصور وفيديوهات مختارة تسلط الضوء على الجمال الحقيقي والأهمية الثقافية للبلاد.';
  ...
  String get privacyPolicyInfoCollection =>
      'هل تسمح لتطبيق 963SY بتشغيل الفيديوهات والجولات الافتراضية على جهازك؟';

  @override
  String get privacyPolicyInfoCollectionContent =>
      'تطبيق 963 هو تطبيق تعود ملكيته لوزارة السياحة السورية ونفذته شركة ArtFly. يساهم في تنفيذ خطة الوزارة في الترويج السياحي من خلال عرض جولات افتراضية لأهم المقومات السياحية';
  ...
  String get privacyPolicyInfoSharingContent =>
      'للحصول على تجربة أفضل، أثناء استخدام خدمتنا، بشكل آمن ومحمي فإننا لن نطلب منك أن تزودنا بمعلومات تعريف شخصية ولا أي نوع آخر من البيانات ولن نطلب اعطائنا اي صلاحيات لهاتفك المحمول. سيتم الاحتفاظ بالمعلومات التي نطلبها من قبلنا واستخدامها كما هو موضح في سياسة الخصوصية هذه.';
  ...
  String get privacyPolicySecurityContent =>
      'لا يجمع التطبيق أي معلومات شخصية ولا يطلب أي اذونات للوصول الى بيانات الجوال او معلومات عنه ولا يجمع أي معلومات عن موقعك الجغرافي.';
  ...
  String get privacyPolicyChildrenContent =>
      'هذه الخدمة مقدمة لجميع الأعمار والأجناس ولا تعرض أي محتوى ضار إطلاقاً ويتم ادارة المحتوى بشكل فعّال.';
  ...
  String get privacyPolicyContactContent =>
      'إذا كانت لديك أي أسئلة أو اقتراحات حول سياسة الخصوصية الخاصة بنا، فلا تتردد في الاتصال بنا على info@963sy.sy.';
  ...
  String get informationCollectionContent =>
      'نقوم بجمع المعلومات اللازمة، بما في ذلك بيانات الموقع والتفضيلات، لتقديم خدماتنا. نحن نضمن حماية بياناتك الشخصية ولا نشاركها مع أطراف ثالثة.';
  ...
  String get securityContent =>
      'نستخدم أحدث تقنيات الأمان لحماية بياناتك. يتم تشفير جميع المعلومات الحساسة.';
  ...
  String get userRightsContent =>
      'لديك الحق في الوصول إلى بياناتك أو تعديلها أو حذفها. يمكنك أيضًا طلب تصدير بياناتك.';
